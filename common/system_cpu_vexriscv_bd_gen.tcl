...
reorder_files -fileset constrs_1 -front [get_files nexys-a7-100t_system_constr.xdc]
...
create_bd_cell -vlnv xilinx.com:ip:clk_wiz:6.0 -module_name clk_wiz_1
...
create_bd_cell -vlnv xilinx.com:ip:proc_sys_reset:5.0 -module_name sys_rstgen
...
set_property CONFIG.NUM_MI 8 [get_bd_cells axi_interconnect]
...
connect_bd_intf_net [get_bd_intf_pins axi_gpio/GPIO] [get_bd_intf_ports GPIO]
...
connect_bd_intf_net [get_bd_intf_pins axi_quad_spi/SPI_0] [get_bd_intf_ports SPI_0]
...
connect_bd_net [get_bd_pins axi_ethernetlite_0/ip2intc_irpt] [get_bd_pins irq_concat/In2]
...
exclude_bd_addr_seg [get_bd_addr_segs inst_ruffle_axi_bscane/m_axi_ibus/SEG_axi_ethernetlite_0_Reg]
